...
function awful_parts_in_js() {
  ...
  // Here is an example:
  function foo(this: any) {    // you can specify function's this type by using a fake this parameter
    console.log(this);         // to avoid: 'this' implicitly has type 'any' because it does not have a type annotation.
  }
